...
class Model():
    ...
    def build_model(self, dt, param):
        ...
        result = param['a0'] + param['a1']*dt[0] + param['a2']*dt[0]**2 + param['a3']*dt[5] +param['a4']*dt[3] + \
                 param['a5']*dt[4] + param['a6']*dt[7] + param['a7'] * dt[8] + param['a8'] * dt[9] + \
                 param['a9'] *dt[1] + param['a10'] * dt[2] +param['a11'] *dt[6]
